...
export const AEGISLASH = {
  SHIELD_FORME: POKEMON.AEGISLASH,
...
export const BASCULIN = {
  RED_STRIPED: POKEMON.BASCULIN,
  BLUE_STRIPED: POKEMON.BASCULIN,
  WHITE_STRIPED: POKEMON.BASCULIN,
};
...
export const CHERRIM = {
  OVERCAST: POKEMON.CHERRIM,
  SUNNY: POKEMON.CHERRIM,
};

export const DARMANITAN = {
  STANDARD_MODE: POKEMON.DARMANITAN,
  ZEN_MODE: POKEMON.DARMANITAN,
};

export const DEERLING = {
  SPRING_FORM: POKEMON.DEERLING,
  SUMMER_FORM: POKEMON.DEERLING,
  AUTUMN_FORM: POKEMON.DEERLING,
  WINTER_FORM: POKEMON.DEERLING,
};
...
export const ENAMORUS = {
  INCARNATE_FORME: POKEMON.ENAMORUS,
  THERIAN_FORME: POKEMON.ENAMORUS,
};

export const ETERNATUS = {
  NORMAL: POKEMON.ETERNATUS,
  ETERNAMAX: POKEMON.ETERNATUS,
};

export const FLABEBE = {
  RED_FLOWER: POKEMON.FLABEBE,
  YELLOW_FLOWER: POKEMON.FLABEBE,
  ORANGE_FLOWER: POKEMON.FLABEBE,
  BLUE_FLOWER: POKEMON.FLABEBE,
  WHITE_FLOWER: POKEMON.FLABEBE,
};

export const FLOETTE = {
  RED_FLOWER: POKEMON.FLOETTE,
  YELLOW_FLOWER: POKEMON.FLOETTE,
  ORANGE_FLOWER: POKEMON.FLOETTE,
  BLUE_FLOWER: POKEMON.FLOETTE,
  WHITE_FLOWER: POKEMON.FLOETTE,
  ETERNAL_FLOWER: POKEMON.FLOETTE,
};

export const FLORGES = Object.fromEntries(Object.keys(FLABEBE).map((flower) => [flower, POKEMON.FLORGES]));

export const FRILLISH = {
  MALE: POKEMON.FRILLISH,
  FEMALE: POKEMON.FRILLISH,
};

export const FURFROU = {
  NATURAL_FORM: POKEMON.FURFROU,
  HEART_TRIM: POKEMON.FURFROU,
  STAR_TRIM: POKEMON.FURFROU,
  DIAMOND_TRIM: POKEMON.FURFROU,
  DEBUTANTE_TRIM: POKEMON.FURFROU,
  MATRON_TRIM: POKEMON.FURFROU,
  DANDY_TRIM: POKEMON.FURFROU,
  LA_REINE_TRIM: POKEMON.FURFROU,
  KABUKI_TRIM: POKEMON.FURFROU,
  PHARAOH_TRIM: POKEMON.FURFROU,
};
...
export const GALARIAN_DARMANITAN = {
  STANDARD_MODE: POKEMON.DARMANITAN,
  ZEN_MODE: POKEMON.DARMANITAN,
};

export const GENESECT = {
  NORMAL: POKEMON.GENESECT,
  DOUSE_DRIVE: POKEMON.GENESECT,
  SHOCK_DRIVE: POKEMON.GENESECT,
  BURN_DRIVE: POKEMON.GENESECT,
  CHILL_DRIVE: POKEMON.GENESECT,
};

export const GIMMIGHOUL = {
  CHEST_FORM: POKEMON.GIMMIGHOUL,
  ROAMING_FORM: POKEMON.GIMMIGHOUL,
};

export const GOURGEIST = {
  AVERAGE_SIZE: POKEMON.GOURGEIST,
  SMALL_SIZE: POKEMON.GOURGEIST,
  LARGE_SIZE: POKEMON.GOURGEIST,
  SUPER_SIZE: POKEMON.GOURGEIST,
};
...
export const HOOPA = {
  CONFINED: POKEMON.HOOPA,
  UNBOUND: POKEMON.HOOPA,
};

export const JELLICENT = {
  MALE: POKEMON.JELLICENT,
  FEMALE: POKEMON.JELLICENT,
};

export const KELDEO = {
  ORDINARY_FORM: POKEMON.KELDEO,
  RESOLUTE_FORM: POKEMON.KELDEO,
};

export const KYUREM = {
  NORMAL: POKEMON.KYUREM,
  BLACK: POKEMON.KYUREM,
  WHITE: POKEMON.KYUREM,
};

export const LANDORUS = {
  INCARNATE_FORME: POKEMON.LANDORUS,
  THERIAN_FORME: POKEMON.LANDORUS,
};

export const LYCANROC = {
  MIDDAY_FORM: POKEMON.LYCANROC,
  MIDNIGHT_FORM: POKEMON.LYCANROC,
...
export const MEOWSTIC = {
  MALE: POKEMON.MEOWSTIC,
  FEMALE: POKEMON.MEOWSTIC,
};
...
export const MORPEKO = {
  FULL_BELLY_MODE: POKEMON.MORPEKO,
  HANGRY_MODE: POKEMON.MORPEKO,
};

export const NECROZMA = {
  NORMAL: POKEMON.NECROZMA,
  DUSK_MANE: POKEMON.NECROZMA,
  DAWN_WINGS: POKEMON.NECROZMA,
...
export const ORICORIO = {
  BAILE_STYLE: POKEMON.ORICORIO,
...
export const PALDEAN_TAUROS = {
  COMBAT_BREED: POKEMON.TAUROS,
  BLAZE_BREED: POKEMON.TAUROS,
  AQUA_BREED: POKEMON.TAUROS,
};

export const POLTCHAGEIST = {
  COUNTERFEIT_FORM: POKEMON.POLTCHAGEIST,
  ARTISAN_FORM: POKEMON.POLTCHAGEIST,
};
...
export const PUMPKABOO = {
  ...
  LARGE_SIZE: POKEMON.PUMPKABOO,
  SUPER_SIZE: POKEMON.PUMPKABOO,
};

export const PYROAR = {
  MALE: POKEMON.PYROAR,
  FEMALE: POKEMON.PYROAR,
};

export const ROTOM = {
  NORMAL: POKEMON.ROTOM,
  HEAT: POKEMON.ROTOM,
  WASH: POKEMON.ROTOM,
  FROST: POKEMON.ROTOM,
  FAN: POKEMON.ROTOM,
...
export const SAWSBUCK = Object.fromEntries(Object.keys(DEERLING).map((season) => [season, POKEMON.SAWSBUCK]));

export const SHAYMIN = {
  LAND_FORME: POKEMON.SHAYMIN,
...
export const SQUAWKABILLY = {
  GREEN_PLUMAGE: POKEMON.SQUAWKABILLY,
  BLUE_PLUMAGE: POKEMON.SQUAWKABILLY,
  YELLOW_PLUMAGE: POKEMON.SQUAWKABILLY,
  WHITE_PLUMAGE: POKEMON.SQUAWKABILLY,
};

export const TATSUGIRI = {
  CURLY_FORM: POKEMON.TATSUGIRI,
  DROOPY_FORM: POKEMON.TATSUGIRI,
  STRETCHY_FORM: POKEMON.TATSUGIRI,
};

export const TERAPAGOS = {
  NORMAL_FORM: POKEMON.TERAPAGOS,
  TERASTAL_FORM: POKEMON.TERAPAGOS,
  STELLAR_FORM: POKEMON.TERAPAGOS,
};

export const THUNDURUS = {
  INCARNATE_FORME: POKEMON.THUNDURUS,
  THERIAN_FORME: POKEMON.THUNDURUS,
};

export const TORNADUS = {
  INCARNATE_FORME: POKEMON.TORNADUS,
  THERIAN_FORME: POKEMON.TORNADUS,
};

export const TOXTRICITY = {
  AMPED_FORM: POKEMON.TOXTRICITY,
  LOW_KEY_FORM: POKEMON.TOXTRICITY,
};
...
export const UNOWN = {
  ...
  Y: POKEMON.UNOWN,
  Z: POKEMON.UNOWN,
  EXCLAMATION_MARK: POKEMON.UNOWN,
  QUESTION_MARK: POKEMON.UNOWN,
};

export const URSHIFU = {
  SINGLE_STRIKE_STYLE: POKEMON.URSHIFU,
  RAPID_STRIKE_STYLE: POKEMON.URSHIFU,
};

export const VIVILLON = {
  ICY_SNOW: POKEMON.VIVILLON,
  POLAR: POKEMON.VIVILLON,
  TUNDRA: POKEMON.VIVILLON,
  CONTINENTAL: POKEMON.VIVILLON,
  GARDEN: POKEMON.VIVILLON,
  ELEGANT: POKEMON.VIVILLON,
  MEADOW: POKEMON.VIVILLON,
  MODERN: POKEMON.VIVILLON,
  MARINE: POKEMON.VIVILLON,
  ARCHIPELAGO: POKEMON.VIVILLON,
  HIGH_PLAINS: POKEMON.VIVILLON,
  SANDSTORM: POKEMON.VIVILLON,
  RIVER: POKEMON.VIVILLON,
  MONSOON: POKEMON.VIVILLON,
  SAVANNA: POKEMON.VIVILLON,
  SUN: POKEMON.VIVILLON,
  OCEAN: POKEMON.VIVILLON,
...
export const ZACIAN = {
  HERO_OF_MANY_BATTLES: POKEMON.ZACIAN,
  CROWNED_SWORD: POKEMON.ZACIAN,
};

export const ZAMAZENTA = {
  HERO_OF_MANY_BATTLES: POKEMON.ZAMAZENTA,
  CROWNED_SHIELD: POKEMON.ZAMAZENTA,
};
