// html-validate's own preset, which needs nothing resolved from node_modules,
// with two rules pointed at the style this file already writes rather than
// turned off. Both are about how to spell a thing, not whether it is right:
