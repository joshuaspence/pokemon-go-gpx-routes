...
// (one coordinate each, from <wpt>) and "hlfavorRoute" is Routes (a whole path, from <trk>). The code below reads those
// keys out of an uploaded backup and writes them back, using the Java serialization codec in java-serialization.js.
// ---------------------------------------------------------------------------------------------------------------------
